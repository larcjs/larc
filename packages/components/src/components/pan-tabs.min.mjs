        ...
        <div class="tab-list">
          ${t.map((a,e)=>`
            <button
              ...
              ${a.disabled?"disabled":""}
            >
              ${a.icon?`<span class="tab-icon">${a.icon}</span>`:""}
              ${a.label}
            </button>
          `).join("")}
        </div>
