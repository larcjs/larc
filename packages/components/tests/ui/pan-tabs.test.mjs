/**
 * pan-tabs UI tests
 * Tests the tabs component functionality including tab switching and keyboard navigation
 */
...
describe('pan-tabs', () => {
  ...
  test('emits events when tab changes', async () => {
    await page.goto(fileUrl('examples/01-hello.html'));
    ...
    const eventPromise = page.evaluate(() => {
      return new Promise((resolve) => {
        ...
        setTimeout(() => {
          const tab2 = tabs.querySelector('[data-tab="b"]');
          tab2?.click();
        }, 100);
      });
    });
