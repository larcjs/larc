 ...
 *
 * Shows temporary notification messages via PAN bus.
 *
 * Usage:
 *   <pan-toast></pan-toast>
 *
 * Then publish messages to 'ui.toast.show':
 *   pc.publish({ topic: 'ui.toast.show', data: { message: 'Hello!', type: 'success', duration: 3000 } });
 *
