  ...
  render(){
    ...
    this.shadowRoot.innerHTML = h`
      <style>
        ...
        label{ display:grid; gap:4px; color: var(--color-text, inherit); }
        ...
        button[type="submit"]{ background: var(--color-accent, #006699); color: white; border-color: var(--color-accent, #006699) }
