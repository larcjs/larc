...
import { PanClient } from 'https://unpkg.com/@larcjs/core@1.0.2/src/components/pan-client.mjs';
```
...
const cdnAvailable = await testCDN('https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs');
...
```html
<!-- ❌ WRONG: HTTP URL -->
<script type="module" src="http://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs"></script>

<!-- ✅ CORRECT: HTTPS URL -->
<script type="module" src="https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs"></script>

<!-- ✅ BETTER: Protocol-relative (not recommended for modules) -->
<script type="module" src="//unpkg.com/@larcjs/core@1.0.2/src/pan.mjs"></script>
```
...
<body>
  ...
  <script type="module">
    import { PanClient } from 'https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs';
