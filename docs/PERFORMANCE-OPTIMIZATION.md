...
<link rel="modulepreload" href="https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs">
<link rel="modulepreload" href="https://unpkg.com/@larcjs/core@1.0.2/src/components/pan-bus.mjs">
...
```javascript
const CDN_SOURCES = [
  'https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs',
  'https://cdn.jsdelivr.net/npm/@larcjs/core@1.0.2/src/pan.mjs',
...
```javascript
window.panAutoload = {
  baseUrl: 'https://unpkg.com/@larcjs/core@1.0.2/',
...
<head>
  ...
  <!-- Load LARC -->
  <script type="module" src="https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs"></script>
</head>
<body>
  <app-header></app-header>
  <app-nav></app-nav>
...
detectRegion().then(region => {
  ...
  window.panAutoload = {
    baseUrl: `${cdnBase}/@larcjs/core@1.0.2/`
  };
});
```
...
async function warmCDNCache() {
  const criticalUrls = [
    'https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs',
    'https://unpkg.com/@larcjs/core@1.0.2/src/components/pan-bus.mjs',
...
// ✅ GOOD
<script type="module" src="https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs"></script>
<script type="module" src="https://unpkg.com/@larcjs/core@1.0.2/src/components/pan-bus.mjs"></script>

// ❌ Avoid multiple domains (uses separate connections)
<script type="module" src="https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/@larcjs/core@1.0.2/src/components/pan-bus.mjs"></script>
```
...
const PRECACHE_URLS = [
  ...
  'https://unpkg.com/@larcjs/core@1.0.2/src/pan.mjs',
  'https://unpkg.com/@larcjs/core@1.0.2/src/components/pan-bus.mjs',
  'https://unpkg.com/@larcjs/core@1.0.2/src/components/pan-client.mjs'
];
